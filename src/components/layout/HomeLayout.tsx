          ...
          {open && (
            ...
            >
              <div className="flex justify-between w-full h-16">
                <div className="text-2xl font-bold text-gray-900 dark:text-primary flex w-full px-4 mt-4 cursor-pointer">
                  <span aria-label="Brand logo">
                    <NavLink
                      to={"/"}
                      onClick={() => setOpen(false)}
              ...
              <div className="h-full flex flex-col justify-between">
                <ul className="flex flex-col gap-2">
                  {navItems.map((item, index) => (
                    <li
                      key={index}
                      className="text-gray-900 dark:text-white hover:bg-gray-700 hover:text-white inline-block px-3 py-2 text-lg font-medium cursor-pointer"
                    >
                      <NavLink
                        to={item.href}
                        onClick={() => setOpen(false)}
